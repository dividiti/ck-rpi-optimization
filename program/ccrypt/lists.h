...
/* $Id: lists.h,v 1.2 2002/12/21 05:47:22 selinger Exp $ */
...
/* append list2 to the end of list. */
...
/* insert the element ELT just before the first element TMP of the
   ...
   list_prepend and then order it with list_mergesort, than to
...
/* merge two sorted lists, store the result in the first list */
...
/* purge duplicates from a sorted list, according to comparison
   condition cond. Of two duplicates, keep the one that is "less". 
   Use the function "free_elt" to free the elements. */
